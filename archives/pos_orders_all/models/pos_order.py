...
class PosOrderLineInherit(models.Model):
	...
	return_qty = fields.Float('Return Qty', compute='_compute_return_qty')
 
	@api.depends('refund_orderline_ids')
	def _compute_return_qty(self):
		for orderline in self:
			orderline.return_qty = -sum(orderline.mapped('refund_orderline_ids.qty'))
